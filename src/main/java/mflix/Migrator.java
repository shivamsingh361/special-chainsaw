...
//            String id = doc.get("_id", Document.class).toString();
            if (imdbRating == null) {
                return null;
            }
            ...
            return new UpdateOneModel<Document>(Filters.eq("_id", doc.getObjectId("_id")), new
        ...
        try {
            if (lastUpdated != null) {
                return new UpdateOneModel<>(
                        ...
                        Updates.set("lastupdated", new java.util.Date(dateFormat.parse(lastUpdated).getTime())));
            }
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix.s0pf4t0.mongodb.net";
        ...
        Bson dateStringFilter =
                new Document("lastupdated",
